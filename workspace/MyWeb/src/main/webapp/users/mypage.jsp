						...
						<fieldset>
							...
							<ul class="reg_list">
								...
								<li class="clear">
									...
									<div class="reg_content" style="padding-top:8px;"><input type="text" class="w70p" placeholder="010-0000-0000" value ="${sessionScope.userDTO.phone }" name = "phone" required pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" /></div>
								</li>
								<li class="clear">
									<span class="tit_lbl">SMS 수신동의</span>
									<div class="reg_content radio_area">
										<input type="radio" class="css-radio" id="smsyes_lbl" name="sms_yn" value = "Y" ${sessionScope.userDTO.snsYn == 'Y' ? 'checked' : ' ' }><label for="smsyes_lbl">허용</label>
										<input type="radio" class="css-radio" id="smsno_lbl" name="sms_yn" value = "N"${sessionScope.userDTO.snsYn == 'N' ? 'checked' : ' ' }><label for="smsno_lbl">거부</label>
